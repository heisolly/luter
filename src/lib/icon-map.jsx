...
export const iconLibraryOrder = ["lucide", "tabler", "phosphor", "hugeicons", "untitledui"];

export const iconLibraryLabels = {
  lucide: "Lucide",
  tabler: "Tabler",
  phosphor: "Phosphor",
  hugeicons: "HugeIcons",
...
function phosphor(Icon) {
  return function PhosphorAdapter({
    ...
    const weight = strokeWidth != null && strokeWidth >= 1.75 ? "regular" : "light";
...
function untitledui(Icon) {
  return function UntitledUiAdapter({
    size,
    strokeWidth,
    className
  }) {
