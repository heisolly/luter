...
export default function ExamSessionView() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fff', fontFamily: "var(--font-outfit), sans-serif" }}>
  ...
  if (error || !session) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fcfaff', padding: 20, textAlign: 'center', fontFamily: "var(--font-outfit), sans-serif" }}>
