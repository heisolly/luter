      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ 
            ...
            boxShadow: '0 10px 24px -10px rgba(151,24,251,0.5)',
            display: 'flex',
            alignItems: 'center',
          ...
          <div>
            <h1 style={{ fontSize: isMobile ? 22 : 32, fontWeight: 800, color: '#111', margin: 0, letterSpacing: '-0.03em', lineHeight: 1 }}>Study Streak</h1>
          ...
          <div style={{ 
            ...
            gap: 12
             ...
             <div style={{ textAlign: 'right' }}>
               <div style={{ fontSize: 10, fontWeight: 800, color: '#999', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Current Rank</div>
               <div style={{ fontSize: 14, fontWeight: 800, color: 'var(--primary)' }}>Academic Titan</div>
             </div>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 16 : 32 }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                <div style={{ 
                  ...
                  border: '1.5px solid #e5e7eb',
                  boxShadow: '0 10px 24px -8px rgba(151,24,251,0.3)',
              ...
              <h2 style={{ fontSize: isMobile ? 40 : 72, fontWeight: 800, color: '#111', margin: '0 0 8px', letterSpacing: '-0.05em', lineHeight: 1.1 }}>
                {streak} Days
              </h2>
              <p style={{ fontSize: isMobile ? 14 : 20, color: 'var(--primary)', fontWeight: 800, marginBottom: isMobile ? 24 : 40 }}>
                {streak === 0 ? "START YOUR LEGACY TODAY" : "ELITE CONSISTENCY ACHIEVED"}
              </p>

              {/* Progress Bar */}
              <div style={{ maxWidth: 400, margin: '0 auto 40px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8, fontSize: 10, fontWeight: 800, textTransform: 'uppercase', color: '#666' }}>
                  <span>Daily Goal</span>
                  <span>75%</span>
                </div>
                <div style={{ width: '100%', height: 16, background: '#f1f5f9', borderRadius: 8, border: '1.5px solid #e5e7eb', overflow: 'hidden' }}>
                   <motion.div initial={{ width: 0 }} animate={{ width: '75%' }} style={{ height: '100%', background: 'linear-gradient(90deg, var(--primary), #a855f7)', borderRight: '1.5px solid #e5e7eb' }} />
                </div>
              </div>
              ...
              <div style={{ 
                ...
                {DAYS.map((day, i) => (
                  <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
                    <span style={{ fontSize: 9, fontWeight: 800, color: i === today ? 'var(--primary)' : '#999', textTransform: 'uppercase' }}>{day.slice(0, 3)}</span>
                    <div style={{ 
                      width: '100%', 
                      aspectRatio: '1/1',
                      borderRadius: isMobile ? 8 : 12, 
                      background: i < today ? 'var(--primary)' : 'white',
                      border: `1.5px solid ${i < today ? 'var(--primary)' : '#e5e7eb'}`,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      boxShadow: i < today ? '0 4px 8px -2px rgba(151,24,251,0.2)' : 'none',
                      transition: 'all 0.2s'
                    }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 12 : 24 }}>
             <div style={{ 
               background: '#fff', padding: isMobile ? '20px' : '24px', borderRadius: 24, border: '1.5px solid #e5e7eb',
               boxShadow: '0 4px 12px rgba(0,0,0,0.03)',
               ...
               <div>
                 <h3 style={{ fontSize: 13, fontWeight: 800, margin: 0 }}>Streak Freeze</h3>
                 <p style={{ fontSize: 11, color: '#666', fontWeight: 600, margin: '2px 0 0' }}>48h Protection Active</p>
               </div>
             </div>

             <div style={{ 
               background: 'var(--primary)', padding: isMobile ? '20px' : '24px', borderRadius: 24, border: '1.5px solid var(--primary-dark)',
               boxShadow: '0 10px 24px -10px rgba(151,24,251,0.4)',
               ...
               <div>
                 <h3 style={{ fontSize: 13, fontWeight: 800, margin: 0 }}>XP Multiplier</h3>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 16 : 32 }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 10, fontWeight: 800, color: 'var(--primary)', background: 'var(--primary-bg)', padding: '4px 10px', borderRadius: 8, border: '1.5px solid var(--primary)' }}>LEVEL 14</div>
            </div>
              ...
              {[
                ...
                <div key={i} style={{ 
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                    <div style={{ fontSize: 12, fontWeight: 800, color: '#111' }}>{quest.t}</div>
                    <div style={{ fontSize: 10, fontWeight: 800, color: 'var(--primary)' }}>{quest.g}</div>
                  </div>
          ...
          <div style={{ 
            ...
            overflow: 'hidden'
             ...
             <h3 style={{ fontSize: 15, fontWeight: 800, margin: '0 0 12px', zIndex: 1, position: 'relative' }}>Power Up</h3>
             ...
             <button style={{ 
               ...
               cursor: 'pointer', zIndex: 1, position: 'relative', boxShadow: '0 8px 24px -6px rgba(151,24,251,0.5)',
               transition: 'all 0.1s'
             }}>
               UPGRADE TO SCHOLAR+
             </button>
