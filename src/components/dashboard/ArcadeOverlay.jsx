      ...
      <div style={{ position: 'relative', marginBottom: 12 }}>
        ...
        <input
          ...
          style={{
            ...
            fontFamily: "var(--font-outfit),sans-serif", color: 'var(--sb-text,#0F172A)',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <button
        ...
        style={{
          ...
          fontFamily: "var(--font-outfit),sans-serif", transition: 'background 0.15s',
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Footer */}
          {isHub && (
            <p style={{ margin: '14px 0 0', textAlign: 'center', fontSize: 11, color: 'var(--sb-text-muted,#94A3B8)', fontWeight: 500, fontFamily: "var(--font-outfit),sans-serif" }}>
