...
export default function NoteRenderer({ material, activeTab, analysisState, onRunAnalysis }) {
  ...
  const renderContent = () => {
    if (activeTab === 'content') {
      return (
        <div style={{ fontFamily: 'var(--font-outfit)', color: '#4C1D95', lineHeight: 1.8, maxWidth: '800px', margin: '0 auto' }}>
    ...
    if (analysisState.loading) {
      return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: '16px' }}>
          ...
          <p style={{ fontFamily: 'var(--font-outfit)', color: '#4C1D95', fontWeight: 600 }}>Luter is thinking...</p>
        </div>
      )
    }
          ...
          <div style={{ background: 'white', borderRadius: '24px', border: '1.5px solid #E2E8F0', padding: '48px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)', position: 'relative' }}>
             ...
             <div style={{ maxWidth: '500px', margin: '0 auto' }}>
               <textarea 
                 ...
                 style={{ width: '100%', padding: '20px', borderRadius: '16px', border: '1.5px solid #E2E8F0', background: '#F8FAFC', outline: 'none', fontSize: '15px', minHeight: '120px', resize: 'none', fontFamily: 'var(--font-outfit)' }}
               />
