  ...
  return (
    <div className="p-6 max-w-6xl mx-auto min-h-screen bg-[#fafbfc]">
      <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-[#1A102D] mb-2 font-sans">Study Requests</h1>
      ...
      <div className="grid gap-6">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <h3 className="text-xl font-extrabold text-[#1A102D] mb-1 font-sans">
                  {req.subject}
                </h3>
        ...
        {requests.length === 0 && (
          <div className="py-24 text-center bg-white rounded-[3rem] border-2 border-dashed border-slate-100">
            ...
            <h3 className="text-2xl font-black text-[#1A102D] mb-2 font-sans">No Requests Yet</h3>
      ...
      <style>{`
        ...
        .font-sans { font-family: 'Varela Round', sans-serif; }
      `}</style>
    </div>
  );
}
