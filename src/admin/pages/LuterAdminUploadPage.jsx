...
export default function LuterAdminUploadPage() {
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', fontFamily: 'var(--font-outfit)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '32px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <select 
              ...
              style={{ padding: '12px', borderRadius: '12px', border: '1.5px solid #E2E8F0', outline: 'none', fontFamily: 'var(--font-outfit)' }}
            >
