...
export default function AdminPricing() {
  ...
  if (loading) {
    return (
      <div style={{ padding: '1.5rem 2rem', maxWidth: 1000, margin: '0 auto', fontFamily: 'var(--font-outfit)' }}>
  ...
  return (
    <div style={{ padding: '1.5rem 2rem', maxWidth: 1000, margin: '0 auto', color: 'var(--color-text-primary)', fontFamily: 'var(--font-outfit)' }}>
