...
export default function MatchingGame({ room, participants, user, deck, onExit }) {
  ...
  if (gameState === "finished") {
    const finalScore = Math.max(0, Math.round(1e4 / (timeElapsed || 1)));
    return /* @__PURE__ */ jsx(
      GameOverScreen,
      {
        score: finalScore,
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, color: "#7c3aed", fontWeight: 800 }, children: [
        /* @__PURE__ */ jsx(Cards, { size: 28, weight: "bold" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: 18, textTransform: "uppercase", letterSpacing: 1 }, children: "Match" })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { fontSize: 24, fontWeight: 900, color: "#1e293b", fontVariantNumeric: "tabular-nums" }, children: [
        timeElapsed.toFixed(1),
        "s"
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 16, color: "#94a3b8" }, children: [
        /* @__PURE__ */ jsx("button", { style: { background: "none", border: "none", cursor: "pointer", color: "inherit" }, title: "Settings", children: /* @__PURE__ */ jsx(Gear, { size: 24, weight: "bold" }) }),
        /* @__PURE__ */ jsx("button", { onClick: onExit, style: { background: "none", border: "none", cursor: "pointer", color: "inherit" }, title: "Close", children: /* @__PURE__ */ jsx(X, { size: 24, weight: "bold" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx(AnimatePresence, { children: cards.map((card) => {
          ...
          return /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              style: {
                ...
                border: matches.includes(card.id) ? "none" : selected?.id === card.id ? "2px solid #7c3aed" : "1px solid #e2e8f0",
                borderRadius: 12,
                display: "flex",
                alignItems: "center",
              ...
              children: [
                feedback === "wrong" && !matches.includes(card.id) && /* @__PURE__ */ jsx(
                  motion.div,
                  {
                    animate: { x: [-2, 2, -2, 2, 0] },
