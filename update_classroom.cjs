...
const content = fs.readFileSync('c:/Softwares/Luter/src/classroom/ClassroomDashboard.jsx', 'utf8');

const startIdx = content.indexOf('  if (rooms.length === 0) {');
...
const newContent = content.substring(0, startIdx) + newReturn;

fs.writeFileSync('c:/Softwares/Luter/src/classroom/ClassroomDashboard.jsx', newContent, 'utf8');
